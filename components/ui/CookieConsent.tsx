        ...
        <>
          ...
          >
            <div className="max-w-4xl mx-auto">
              <div className="bg-black border-2 border-white rounded-lg p-6 shadow-2xl">
                {!showSettings ? (
                  // Main consent banner
                  <div>
                    <div className="flex items-start space-x-4 mb-6">
                      <div className="flex-shrink-0 p-2 border border-white/20 wireframe rounded-lg">
                        <Cookie className="h-6 w-6 text-white icon-outline" />
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <button
                        ...
                        className="fuego-btn text-white"
                      >
                        Reject All
                      </button>
                      <button
                    ...
                    {/* Privacy Guarantee */}
                    <div className="mt-4 p-3 glass border border-white/20 rounded-lg">
                      <div className="flex items-center space-x-2">
                        <Shield className="h-4 w-4 text-white icon-outline" />
                  ...
                  <div>
                    ...
                    <div className="space-y-4 mb-6">
                      {cookieTypes.map((type) => (
                        <div key={type.id} className="flex items-start justify-between p-4 glass border border-white/10 rounded-lg">
                          <div className="flex-1">
                          ...
                          <div className="ml-4">
                            {type.required ? (
                              <div className="px-3 py-1 glass border border-white/20 rounded-full text-xs text-white">
                                Required
                              </div>
                            ) : (
